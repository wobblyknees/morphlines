 ...
 */
public final class KafkaBuilder implements CommandBuilder {
  ...
  public Command build(Config config, Command parent, Command child, MorphlineContext context) {
    return new Kafka(this, config, parent, child, context);
  }
  ...
  // Nested classes:
  ///////////////////////////////////////////////////////////////////////////////
  private static final class Kafka extends AbstractCommand {
    
    private final String fieldName;
    private final Locale locale;
    private final boolean reverse;

    public Kafka(CommandBuilder builder, Config config, Command parent, Command child, MorphlineContext context) {
